...
const INFO_CARDS = [
  { icon: "🔒", title: "Sécurisé", text: "Vos données restent locales à cette démonstration." },
  { icon: "🕑", title: "Suivi en temps réel", text: "Suivez l'état de votre demande avec votre code." },
  { icon: "📄", title: "Documents en ligne", text: "Téléversez vos pièces justificatives au format PDF." },
  { icon: "💳", title: "Paiement en ligne", text: "Réglez les frais de dossier (simulation)." },
];
